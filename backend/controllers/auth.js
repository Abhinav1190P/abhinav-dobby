//Creating the controller (functions) for sign up, sign in and refresh tokens (tokens are basically stored in the frontend for a limited amount of time, to let the user remain authenticated)
